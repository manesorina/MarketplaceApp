...
//        product5.setCategory(categoryTops.getId());
       ...
       controller.likeProduct(user1.getUserName(),user1.getPassword(),product1.getId()) ;
       controller.likeProduct(user1.getUserName(),user1.getPassword(),product1.getId()) ;
     ...
     //   Order order1=new Order(orderedProducts1,"shipped","Strada xyz",user3.getId(),user1.getId());
      ...
      //  Review review1=new Review(3.6,"Acceptable service",user3.getId(),user2.getId());
       ...
       // fileProductRepo.create(product6);
        ...
        //Product product7 = new Product( "Another Winter Top", "Blue", 32, 10.99, "BrandB", "Used", 150, 25, user2.getId());
        //product7.setCategory(categoryTops.getId());
        //fileProductRepo.create(product7);
